...
public class CadastraTarefas extends javax.swing.JFrame {
    ...
    private void jButtonCancelarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonCancelarActionPerformed
        ...
        jcomboPrior.setSelectedIndex(0);
        jcheckConcluida.setSelected(false);
        jtxtCriacao.setText("");
    }//GEN-LAST:event_jButtonCancelarActionPerformed

    private void jButtonListarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonListarActionPerformed
        // TODO add your handling code here:
        List<Tarefa> tarefas = (new TarefaController()).getTarefas();
        StringBuilder listaTarefas = new StringBuilder();
        for (Tarefa tarefa : tarefas) {
        listaTarefas.append(tarefa.toString()).append("\n");
    }
    JOptionPane.showMessageDialog(rootPane, listaTarefas.toString());
